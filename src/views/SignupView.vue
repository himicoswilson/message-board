...
const rules = reactive({
  ...
  verificationCode: [{required: true,message: 'Please input your verification code',trigger: 'blur',},
  ],
  username: [
...
const getVerificationCode = (async() => {
  ...
  await auth.apiSendVerificationCode(userValidateForm.email).then(() => {
...
const getSignup = (async() => {
  ...
  try {
    ...
    await user.apiSignup(userValidateForm.email, userValidateForm.username, userValidateForm.password, token)
  ...
  <div class="signupContainer">
    ...
    <el-form class="signup-form" :model="userValidateForm" :rules="rules" ref="signupForm">
      ...
      <el-form-item prop="email">
        <el-input v-model="userValidateForm.email" id="email" autofocus="true" @keyup.enter="getSignup()">
          <template #append>
      ...
      <el-form-item prop="verificationCode">
        <el-input v-model="userValidateForm.verificationCode" id="verificationCode" @keyup.enter="getSignup()"/>
      </el-form-item>
